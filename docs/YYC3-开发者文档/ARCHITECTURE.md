...
- [一、技术栈全景](#一技术栈全景--tech-stack)
- [二、六域五层架构图](#二六域五层架构图--six-domain-five-layer-architecture)
- [三、全链路数据流](#三全链路数据流--end-to-end-data-flow)
- [四、图标体系消费链](#四图标体系消费链--icon-system-chain)
- [五、目录结构映射](#五目录结构映射--directory-mapping)
- [六、关键设计决策](#六关键设计决策--key-design-decisions)
