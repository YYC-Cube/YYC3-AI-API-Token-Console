...
const zhCN = {
  ...
  nav: {
    ...
    aiFamilyMusic: "音乐资讯",
    aiFamilyGrowth: "成长轨迹",
    aiFamilyDesign: "Family 规划",
    aiFamilyPhone: "家人热线",
    aiFamilyFun: "文娱中心",
    aiFamilyActivities: "全家活动",
    aiFamilyModels: "模型控制",
    aiFamilyVoice: "语音系统",
    aiFamilyData: "数据中心",
    aiFamilyComm: "通信中心",
  ...
  pwa: {
    ...
    cacheDetails: "缓存详情",
    installApp: "安装到桌面",
    installDesc: "添加到桌面，获得��生应用体验，支持离线使用",
    online: "在线",
    offline: "离线模式",
